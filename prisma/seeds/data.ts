...
export const Circles = {
  ...
  Continent: {
    NorthAmerica: {
      ...
      ...circleBase,
      name: "North America",
      countryRestriction: ["North America"],
    } as CircleSchemaType,
    SouthAmerica: {
      id: "16",
      label: "South America",
      ...circleBase,
      name: "South America",
      countryRestriction: ["South America"],
    } as CircleSchemaType,
    Europe: {
      id: "17",
      label: "Europe",
