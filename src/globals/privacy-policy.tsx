...
import { LegalHeading2 } from "@/components/Legal/LegalHeading2";
import { LegalHeading3 } from "@/components/Legal/LegalHeading3";
import { LegalList } from "@/components/Legal/LegalList";
import { LegalStrong } from "@/components/Legal/LegalStrong";
import React from "react";

export const privacyPolicy = (
  <div id="privacyPolicy">
    <LegalHeading className="my-16 justify-center text-xl underline-offset-8">
      Privacy Policy
    </LegalHeading>
    <LegalBody>Last updated: September 25, 2023</LegalBody>
    <LegalBody>
    ...
    <LegalHeading>Interpretation and Definitions</LegalHeading>
    <LegalHeading2>Interpretation</LegalHeading2>
    <LegalBody>
      The words of which the initial letter is capitalized have meanings defined
      under the following conditions. The following definitions shall have the
      same meaning regardless of whether they appear in singular or in plural.
    </LegalBody>
    <LegalHeading2>Definitions</LegalHeading2>
    <LegalBody>For the purposes of this Privacy Policy:</LegalBody>
    <LegalList>
      <LegalStrong>Account</LegalStrong> means a unique account created for You
      to access our Service or parts of our Service.
    </LegalList>
    <LegalList>
      <LegalStrong>Affiliate</LegalStrong> means an entity that controls, is
    ...
    <LegalList>
      <LegalStrong>Company</LegalStrong> (referred to as either &quot;the
      Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this
      Agreement) refers to CircleDating.
    </LegalList>
    <LegalList>
      <LegalStrong>Cookies</LegalStrong> are small files that are placed on Your
    ...
    <LegalList>
      <LegalStrong>Country</LegalStrong> refers to: Missouri, United States
    </LegalList>
    <LegalList>
      <LegalStrong>Device</LegalStrong> means any device that can access the
      Service such as a computer, a cellphone or a digital tablet.
    </LegalList>
    <LegalList>
      <LegalStrong>Personal Data</LegalStrong> is any information that relates
      to an identified or identifiable individual.
    </LegalList>
    <LegalList>
      <LegalStrong>Service</LegalStrong> refers to the Website.
    </LegalList>
    <LegalList>
      <LegalStrong>Service Provider</LegalStrong> means any natural or legal
    ...
    <LegalList>
      <LegalStrong>Usage Data</LegalStrong> refers to data collected
    ...
    <LegalList>
      <LegalStrong>Website</LegalStrong> refers to CircleDating, accessible from{" "}
      <a
        href="https://www.dateinyourcircle.com/"
        rel="external nofollow noopener noreferrer"
        target="_blank"
      >
        https://www.dateinyourcircle.com/
      </a>
    </LegalList>
    <LegalList>
      <LegalStrong>You</LegalStrong> means the individual accessing or using the
      Service, or the company, or other legal entity on behalf of which such
      individual is accessing or using the Service, as applicable.
    </LegalList>
    <LegalHeading>Collecting and Using Your Personal Data</LegalHeading>
    <LegalHeading2>Types of Data Collected</LegalHeading2>
    <LegalHeading3>Personal Data</LegalHeading3>
    <LegalBody>
    ...
    <LegalList>Email address</LegalList>
    <LegalList>Address, State, Province, ZIP/Postal code, City</LegalList>
    <LegalList>Usage Data</LegalList>
    <LegalHeading3>Usage Data</LegalHeading3>
    <LegalBody>
    ...
    <LegalHeading3>Tracking Technologies and Cookies</LegalHeading3>
    <LegalBody>
    ...
    <LegalList>
      <LegalStrong>Cookies or Browser Cookies.</LegalStrong> A cookie is a small
    ...
    <LegalList>
      <LegalStrong>Web Beacons.</LegalStrong> Certain sections of our Service
    ...
    <LegalList>
      <LegalStrong>Necessary / Essential Cookies</LegalStrong>
    </LegalList>
    <LegalList>Type: Session Cookies</LegalList>
    <LegalList>Administered by: Us</LegalList>
    <LegalList>
    ...
    <LegalList>
      <LegalStrong>Cookies Policy / Notice Acceptance Cookies</LegalStrong>
    </LegalList>
    <LegalList>Type: Persistent Cookies</LegalList>
    <LegalList>Administered by: Us</LegalList>
    <LegalList>
    ...
    <LegalList>
      <LegalStrong>Functionality Cookies</LegalStrong>
    </LegalList>
    <LegalList>Type: Persistent Cookies</LegalList>
    <LegalList>Administered by: Us</LegalList>
    <LegalList>
    ...
    <LegalHeading2>Use of Your Personal Data</LegalHeading2>
    <LegalBody>
      The Company may use Personal Data for the following purposes:
    </LegalBody>
    <LegalList>
      <LegalStrong>To provide and maintain our Service</LegalStrong>, including
      to monitor the usage of our Service.
    </LegalList>
    <LegalList>
      <LegalStrong>To manage Your Account:</LegalStrong> to manage Your
    ...
    <LegalList>
      <LegalStrong>For the performance of a contract:</LegalStrong> the
    ...
    <LegalList>
      <LegalStrong>To contact You:</LegalStrong> To contact You by email,
    ...
    <LegalList>
      <LegalStrong>To provide You</LegalStrong> with news, special offers and
    ...
    <LegalList>
      <LegalStrong>To manage Your requests:</LegalStrong> To attend and manage
      Your requests to Us.
    </LegalList>
    <LegalList>
      <LegalStrong>For business transfers:</LegalStrong> We may use Your
    ...
    <LegalList>
      <LegalStrong>For other purposes</LegalStrong>: We may use Your information
    ...
    <LegalList>
      <LegalStrong>With Service Providers:</LegalStrong> We may share Your
      personal information with Service Providers to monitor and analyze the use
      of our Service, to contact You.
    </LegalList>
    <LegalList>
      <LegalStrong>For business transfers:</LegalStrong> We may share or
      transfer Your personal information in connection with, or during
      negotiations of, any merger, sale of Company assets, financing, or
      acquisition of all or a portion of Our business to another company.
    </LegalList>
    <LegalList>
      <LegalStrong>With Affiliates:</LegalStrong> We may share Your information
    ...
    <LegalList>
      <LegalStrong>With business partners:</LegalStrong> We may share Your
      information with Our business partners to offer You certain products,
      services or promotions.
    </LegalList>
    <LegalList>
      <LegalStrong>With other users:</LegalStrong> when You share personal
    ...
    <LegalList>
      <LegalStrong>With Your consent</LegalStrong>: We may disclose Your
      personal information for any other purpose with Your consent.
    </LegalList>
    <LegalHeading2>Retention of Your Personal Data</LegalHeading2>
    <LegalBody>
    ...
    <LegalHeading2>Transfer of Your Personal Data</LegalHeading2>
    <LegalBody>
    ...
    <LegalHeading2>Delete Your Personal Data</LegalHeading2>
    <LegalBody>
    ...
    <LegalHeading2>Disclosure of Your Personal Data</LegalHeading2>
    <LegalHeading3>Business Transactions</LegalHeading3>
    <LegalBody>
    ...
    <LegalHeading3>Law enforcement</LegalHeading3>
    <LegalBody>
    ...
    <LegalHeading3>Other legal requirements</LegalHeading3>
    <LegalBody>
      The Company may disclose Your Personal Data in the good faith belief that
      such action is necessary to:
    </LegalBody>
    <LegalList>Comply with a legal obligation</LegalList>
    <LegalList>
    ...
    <LegalList>Protect against legal liability</LegalList>
    <LegalHeading2>Security of Your Personal Data</LegalHeading2>
    <LegalBody>
    ...
    <LegalBody>
      ...
      <a
        href="https://www.dateinyourcircle.com/help"
        rel="external nofollow noopener noreferrer"
        target="_blank"
      >
        https://www.dateinyourcircle.com/help
      </a>
    </LegalBody>
  </div>
);
