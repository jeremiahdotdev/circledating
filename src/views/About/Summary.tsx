...
export function Summary() {
  return (
    <div className="my-8 space-y-4 p-8 leading-relaxed">
      ...
      <p>
        While Circle Dating was created and is owned by Christians, it is not a
        Christian dating service. At Circle, we believe that marriage is a good
        thing, regardless of your religion.
      </p>
    </div>
  );
}
