...
import body from "public/icons/body";
...
const toggleHollowStyleBoy = {
  style: classNames(
    toggleHollow,
    "text-boy-accent fill-boy-accent border-boy-accent"
  ),
  activeStyle: "bg-boy-accent fill-white text-white",
  width: "w-24",
  height: "h-24",
};
const toggleHollowStyleGirl = {
  style: classNames(
    toggleHollow,
    "text-girl-accent fill-girl-accent border-girl-accent"
  ),
  activeStyle: "bg-girl-accent fill-white text-white",
  width: "w-24",
  height: "h-24",
};
...
export const IconButtonVariant = {
  ...
  } as unknown as IconButtonOption,
  FEMALE: {
    label: "Female",
    icon: faVenus,
  ...
  BODY_FEMALE_EXTRA: {
    label: "Extra",
    svg: body.female.extra,
    ...toggleHollowStyleGirl,
  } as unknown as IconButtonOption,
  BODY_FEMALE_HEAVY: {
    label: "Heavy",
    svg: body.female.heavy,
    ...toggleHollowStyleGirl,
  } as unknown as IconButtonOption,
  PLANE: {
    label: "Yes",
